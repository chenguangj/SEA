...
const metrics = [
  {
    ...
    sub: "E-commerce, finance & logistics",
  },
  {
    value: 99.9,
    suffix: "%",
  ...
  },
  {
    ...
    sub: "Native-speaker fluency verified",
  },
  {
    value: 200,
    suffix: "K",
    ...
    sub: "Claude architecture advantage",
  },
];
...
export function MetricsSection() {
  ...
  // 只在客户端挂载后才启动时钟，避免 SSR/hydration 时间不匹配
  useEffect(() => {
    setTime(new Date());
